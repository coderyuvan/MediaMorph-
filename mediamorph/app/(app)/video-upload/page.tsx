      ...
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-lg w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {/* Adding margin-top to create gap */}
            <div className="mt-4">
              <input
                type="file"
                accept="video/*"
          ...
          <button
            type="submit"
            className={`btn w-full p-3 text-white text-xl font-semibold rounded-lg transition-all duration-300 ${isUploading ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'}`}
